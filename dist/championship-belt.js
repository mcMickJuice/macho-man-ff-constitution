...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CurrentHolder = __webpack_require__(189);
	
	var _CurrentHolder2 = _interopRequireDefault(_CurrentHolder);
	
	var _MatchupWithPopover = __webpack_require__(192);
	
	var _MatchupWithPopover2 = _interopRequireDefault(_MatchupWithPopover);
	
	var _championshipBeltPath = __webpack_require__(193);
	
	var css = _interopRequireWildcard(_championshipBeltPath);
	    ...
	    _createClass(ChampionshipBeltPath, [{
	        ...
	        value: function render() {
	            ...
	            var resultsElements = results.map(function (r) {
	                return _react2.default.createElement(_MatchupWithPopover2.default, { key: r.week,
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'current-holder-container' },
	                    _react2.default.createElement(_CurrentHolder2.default, null)
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'belt-path-container' },
	                    _react2.default.createElement(
	                        'h2',
	                        null,
	                        'Belt Path ',
...
/***/ function(module, exports) {
	...
	function extractCurrentHolderInfo(matchup) {
	    ...
	    var team = teamObj.team;
	    var imageUrl = teamObj.imageUrl;
	...
	var getCurrentHolder = exports.getCurrentHolder = function getCurrentHolder() {
	    return getResults().then(function (results) {
	        var completedWeeksDescending = results.filter(function (r) {
	            return r.holder.score != null;
	        }).sort(function (first, second) {
	            return first.week < second.week;
	        }); //order descending by week
	
	        var currentHolder = extractCurrentHolderInfo(completedWeeksDescending[0]);
	        var currentStreak = completedWeeksDescending.reduce(function (streak, next) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _currentHolder = __webpack_require__(190);
	
	var less = _interopRequireWildcard(_currentHolder);
	...
	var CurrentHolder = function (_Component) {
	    _inherits(CurrentHolder, _Component);
	
	    function CurrentHolder() {
	        _classCallCheck(this, CurrentHolder);
	
	        var _this = _possibleConstructorReturn(this, (CurrentHolder.__proto__ || Object.getPrototypeOf(CurrentHolder)).call(this));
	    ...
	    _createClass(CurrentHolder, [{
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            var _this2 = this;
	
	            (0, _dataService.getCurrentHolder)().then(function (holder) {
	        ...
	        key: 'render',
	        value: function render() {
	            var holder = this.state.holder;
	
	
	            return _react2.default.createElement(
	                'div',
	                { className: 'mm-current-holder' },
	                _react2.default.createElement(
	                    'div',
	                    null,
	                    _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'mm-current-holder__team-name' },
	                    holder.team
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'mm-current-holder__streak' },
	                    'Current Streak: ',
	                    holder.streak
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'mm-current-holder__team-image' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/less-loader/index.js!./current-holder.less", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/less-loader/index.js!./current-holder.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".mm-current-holder__team-name {\n  margin-bottom: 10px;\n}\n.mm-current-holder__team-image img {\n  max-height: 300px;\n  display: block;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	MatchupWithPopover.propTypes = {
	    showPopover: _react.PropTypes.bool,
	    week: _react.PropTypes.number.isRequired,
	    holder: _shapes.teamShape.isRequired,
	    challenger: _shapes.teamShape.isRequired,
	    onMatchupSelected: _react.PropTypes.func.isRequired
	};
	
	exports.default = MatchupWithPopover;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/less-loader/index.js!./championship-belt-path.less", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/less-loader/index.js!./championship-belt-path.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
